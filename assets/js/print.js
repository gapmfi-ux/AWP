...
const printUtils = {
  ...
  // Print Voucher - Uses native window.print() with @media print CSS
  printVoucher: function() {
    // Simply trigger native print using window.print()
    // The CSS @media print rules will handle hiding the modal actions and showing only the voucher
    window.print();
  },
